...
function preload(){
  ...
  boyImg = loadAnimation("Cara.gif")
  cashImg = loadImage("metal.png");
  diamondsImg = loadImage("coca cola.jpg");
  jewelryImg = loadImage("munição.jpg");
  swordImg = loadImage("Zumbi.gif");
  endImg =loadAnimation("fimdeJogo.png");
  morte = loadSound("somdamorte.mp3")
...
function draw() {
  ...
  textSize(20);
  fill(255);
  text("Recursos: "+ treasureCollection,10,30);
  }
